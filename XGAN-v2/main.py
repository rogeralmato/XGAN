...
parser.add_argument('--dataset_dir_A', dest='dataset_dir_A', default='../dataset_cartoon/cartoonset10k', help='path of the dataset A')
parser.add_argument('--dataset_dir_B', dest='dataset_dir_B', default='../dataset_real/white_bg', help='path of the dataset B')
